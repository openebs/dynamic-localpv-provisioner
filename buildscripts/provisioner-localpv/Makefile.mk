...
provisioner-localpv-image.arm64: provisioner-localpv
	...
	@echo "-------------------------------"
	@cp bin/provisioner-localpv/${PROVISIONER_LOCALPV} buildscripts/provisioner-localpv/
	@cd buildscripts/provisioner-localpv && docker build -t ${IMAGE_ORG}/provisioner-localpv-arm64:${IMAGE_TAG} -f Dockerfile.arm64 ${DBUILD_ARGS} --build-arg BASE_IMAGE=${BASE_DOCKER_IMAGE_ARM64} . --no-cache
	@rm buildscripts/provisioner-localpv/${PROVISIONER_LOCALPV}
...
provisioner-localpv-image.ppc64le: provisioner-localpv
	...
	@echo "-------------------------------"
	@cp bin/provisioner-localpv/${PROVISIONER_LOCALPV} buildscripts/provisioner-localpv/
	@cd buildscripts/provisioner-localpv && docker build -t ${IMAGE_ORG}/provisioner-localpv-ppc64le:${IMAGE_TAG} -f Dockerfile.ppc64le ${DBUILD_ARGS} --build-arg BASE_IMAGE=${BASE_DOCKER_IMAGE_PPC64LE} . --no-cache
	@rm buildscripts/provisioner-localpv/${PROVISIONER_LOCALPV}
