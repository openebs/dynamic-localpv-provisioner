...
type updateFn func(cli *kubernetes.Clientset, sc *storagev1.StorageClass) (*storagev1.StorageClass, error)
...
func (k *Kubeclient) withDefaults() {
	...
	if k.del == nil {
		k.del = func(cli *kubernetes.Clientset, name string, deleteOpts *metav1.DeleteOptions) error {
			return cli.StorageV1().StorageClasses().Delete(name, deleteOpts)
		}
	}
	...
	if k.delCollection == nil {
		k.delCollection = func(cli *kubernetes.Clientset, listOpts metav1.ListOptions, deleteOpts *metav1.DeleteOptions) error {
			return cli.StorageV1().StorageClasses().DeleteCollection(deleteOpts, listOpts)
		}
	}
	...
	if k.update == nil {
		k.update = func(cli *kubernetes.Clientset, sc *storagev1.StorageClass) (*storagev1.StorageClass, error) {
			return cli.StorageV1().StorageClasses().Update(sc)
		}
	}
}
...
func (k *Kubeclient) Update(sc *storagev1.StorageClass) (*storagev1.StorageClass, error) {
	if sc == nil {
