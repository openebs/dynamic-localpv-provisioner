...
| ------------------------------------------- | --------------------------------------------- | ----------------------------------------- |
| `release.version`                           | LocalPV Provisioner release version               | `2.6.0`                         |
...
| `localpv.image.tag`                         | Image tag for LocalPV Provisioner                 | `2.6.0`                         |
...
| `helperPod.image.tag`                       | Image tag for helper image                        | `2.6.0`                         |
